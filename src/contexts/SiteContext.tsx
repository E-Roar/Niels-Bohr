...
const frData: SiteData = {
    siteInfo: {
        ...
        tagline: 'Établissement privé à Sidi Bouzid – El Jadida',
        logo: logo,
        email: 'academiegeorgesclaude@gmail.com',
        phone: '05233-48010',
        whatsapp: '212523348010', // Updating to match landline format for WA API if supported, else same.
        address: 'Académie Georges Claude, centre Sidi Bouzid, El Jadida, Morocco',
        city: 'El Jadida',
        country: 'Maroc',
    },
    hero: {
        title: 'Bienvenue à',
        highlight: 'Georges Claude Academy',
        subtitle: "Apprendre avec exigence, réussir avec confiance. De la maternelle au lycée, une excellence reconnue.",
        ...
        ctaSecondary: "Découvrir l'académie",
    },
    about: {
        title: 'Pourquoi choisir',
        highlight: 'Georges Claude',
        subtitle: "Notre établissement est reconnu pour son excellence et sa rigueur, offrant un parcours complet de la maternelle au lycée.",
        features: [
            ...
            { icon: 'Award', title: 'Suivi Personnalisé', description: 'Accompagnement individuel de la maternelle au lycée.', color: 'green' },
        ...
        missionText: "Apprendre avec exigence, réussir avec confiance.",
    },
    programs: {
        title: 'Nos',
        highlight: 'Cycles',
        subtitle: "De la maternelle au lycée, un parcours d'excellence.",
        programs: [
            { icon: 'Baby', title: 'Maternelle', age: '3 - 5 ans', description: "L'éveil et la socialisation.", features: ['Éveil sensoriel', 'Motricité', 'Langage', 'Autonomie'], color: 'yellow' },
    ...
    gallery: {
        title: 'Notre',
        highlight: 'Campus',
        subtitle: "Découvrez nos infrastructures modernes à Sidi Bouzid.",
        images: [
            ...
            { id: '6', src: gallery6, title: 'Extérieurs', description: 'Cadre agréable à Sidi Bouzid' },
        ],
    },
    contact: {
        title: '',
    ...
    chatbot: {
        name: 'Assistant Georges Claude',
        avatar: chatbotAvatar,
        greeting: "Bonjour ! 👋 Je suis l'assistant virtuel de l'Académie Georges Claude.\n\nJe peux vous renseigner sur nos cycles, de la maternelle au lycée, et sur les inscriptions.\n\nComment puis-je vous aider ?",
        systemPrompt: "Tu es l'assistant de l'Académie Georges Claude, un établissement privé d'excellence de la maternelle au lycée à Sidi Bouzid, El Jadida.",
        ragFiles: [],
        fallbackResponse: "Je ne suis pas sûr de la réponse. N'hésitez pas à nous appeler au 05233-48010 ou à nous envoyer un email. 📞",
    },
};
...
const arData: SiteData = {
    siteInfo: {
        name: 'أكاديمية جورج كلود الخاصة',
        tagline: 'مؤسسة خاصة في سيدي بوزيد - الجديدة',
        logo: logo,
        email: 'academiegeorgesclaude@gmail.com',
        phone: '05233-48010',
        whatsapp: '212523348010',
        address: 'أكاديمية جورج كلود، مركز سيدي بوزيد، الجديدة، المغرب',
        city: 'الجديدة',
        country: 'المغرب',
    },
    hero: {
        title: 'مرحباً بكم في',
        highlight: 'أكاديمية جورج كلود',
        subtitle: "التعلم بصرامة، النجاح بثقة. من الروض إلى الثانوي، تميز معترف به.",
        ...
        ctaPrimary: 'سجل طفلك',
        ctaSecondary: "اكتشف الأكاديمية",
    },
    about: {
        title: 'لماذا تختار',
        highlight: 'جورج كلود',
        subtitle: "مؤسستنا معروفة بتميزها وصرامتها، وتقدم مساراً دراسياً كاملاً من الروض إلى الثانوي.",
        features: [
            ...
            { icon: 'Award', title: 'متابعة شخصية', description: 'مرافقة فردية من الروض إلى الثانوي.', color: 'green' },
        ...
        missionTitle: 'شعارنا',
        missionText: "التعلم بصرامة، النجاح بثقة.",
    },
    programs: {
        title: 'اكتشف',
        highlight: 'أسلاكنا',
        subtitle: "من الروض إلى الثانوي، مسار من التميز.",
        programs: [
    ...
    gallery: {
        title: 'جولة في',
        highlight: 'الأكاديمية',
        subtitle: "اكتشف فضاءاتنا الحديثة في سيدي بوزيد.",
    ...
    contact: {
        ...
        features: ['رد سريع', "لقاء مع الإدارة", 'زيارة الأكاديمية'],
    },
    chatbot: {
        name: 'مساعد جورج كلود',
        avatar: chatbotAvatar,
        greeting: "مرحباً! 👋 أنا المساعد الذكي لأكاديمية جورج كلود.\n\nيمكنني مساعدتك بمعلومات حول أسلاكنا، من الروض للثانوي، وعن التسجيل.\n\nكيف يمكنني مساعدتك؟",
        systemPrompt: "أنت مساعد أكاديمية جورج كلود، مؤسسة خاصة متميزة من الروض إلى الثانوي في سيدي بوزيد، الجديدة.",
        ragFiles: [],
        fallbackResponse: "عذراً، لم أتمكن من الإجابة. يمكنك الاتصال بنا على 05233-48010 أو مراسلتنا. 📞",
    },
};
