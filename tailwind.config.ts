  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'glow-rainbow': '0 0 30px hsl(280 70% 55% / 0.3), 0 0 60px hsl(195 85% 50% / 0.2), 0 0 90px hsl(45 100% 55% / 0.15)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(280 70% 55% / 0.3)" },
          "50%": { boxShadow: "0 0 40px hsl(280 70% 55% / 0.6), 0 0 60px hsl(195 85% 50% / 0.3)" },
        },
      },
      animation: {
